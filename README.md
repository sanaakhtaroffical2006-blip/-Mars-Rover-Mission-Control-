# Mars Rover Mission Control - Updated Requirements
...
- **FR-04 (CR-01 Updated):** The rover shall enter Safe Mode within 3 seconds when battery temperature exceeds the critical threshold or battery capacity falls below the defined emergency level.
...
- **NFR-02 (CR-03 Updated):** The system shall require authenticated and role-authorized operators before accepting rover commands.
- **NFR-03:** The system shall continue operating despite temporary communication interruptions.
- **NFR-04 (CR-02 Updated):** The system shall support at least 20 simultaneously connected rovers.
